...
Geromes Portfolio will replace some default HTML elements to Once UI components to integrate better in the design and add additional functionality. Furthermore, many common Once UI components are already imported and available for use.
...
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/feedback" weight="default" label="View more" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button disabled weight="default" label="View more" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/codeBlock" weight="default" label="View more" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/inlineCode" weight="default" label="View more" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/accordion" weight="default" label="View more" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/button" weight="default" label="View more" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/card" weight="default" label="View more" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/icon" weight="default" label="View more" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/flex" weight="default" label="View more" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/grid" weight="default" label="View more" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/smartImage" weight="default" label="View more" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/smart-link" weight="default" label="View more" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>

## Custom components

Since Geromes Portfolio is based on once-ui you can use all the components provided by Once UI in the `.mdx` files, but you need to import them first in the `src/product/mdx.tsx` file and pass it to the `components` object.
