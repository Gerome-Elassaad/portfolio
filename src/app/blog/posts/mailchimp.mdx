...
summary: "Set up the Mailchimp newsletter block for your Geromes Portfolio."
...
Create a new [embed form](https://mailchimp.com/help/add-a-signup-form-to-your-website/) and copy the form URL to your Geromes Portfolio config.
